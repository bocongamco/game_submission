// data.js — edit this file to control the pairs
// Add/modify items; keep unique id per pair.
// sEmoji/cEmoji render as the big image emojis on the cards.
window.PAIRS = [
    { id: 1, stress: "Exam Arc (No Riz)",           cope: "Stayed Hydration and Lock-in",        sEmoji:"😵‍💫", cEmoji:"💧" },
